...
export function getResultTitle(result) {
  const homeTeam = result.getSnippet("home_team") || result.raw?.home_team || "Equipo local";
  const awayTeam = result.getSnippet("away_team") || result.raw?.away_team || "Equipo visitante";
